...
class Nadam(Optimizer):
    ...
    def step(self, closure=None):
        ...
        Arguments:
            closure (callable, optional): A closure that reevaluates the model_estimator
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if len(state) == 0:   #if first time to run...init dictionary with our desired entries
                        ...
                        #print("Initializing slow buffer...should not see this at load from saved model_estimator!")
                    state['step'] = 0
